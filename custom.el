(custom-set-variables
 ...
 '(highlight-tail-colors
   ((("#2c3e3c" "#2a3b2e" "green") . 0) (("#313d49" "#2f3a3b" "brightcyan") . 20)))
 ...
 '(safe-local-variable-values
   '((lsp-pyright-python-executable-cmd
      . "/home/ubuntu/.pyenv/versions/nd-prompt/bin/python")
     (lsp-pyright-venv-directory . "nd-prompt")
     (lsp-pyright-venv-path . "/home/ubuntu/.pyenv/versions/")
 ...
 '(vc-annotate-color-map
   (list (cons 20 "#50fa7b") (cons 40 "#85fa80") (cons 60 "#bbf986")
         ...
         (cons 140 "#ffb86c") (cons 160 "#ffa38a") (cons 180 "#ff8ea8")
         (cons 200 "#ff79c6") (cons 220 "#ff6da0") (cons 240 "#ff617a")
         (cons 260 "#ff5555") (cons 280 "#d45558") (cons 300 "#aa565a")
         (cons 320 "#80565d") (cons 340 "#6272a4") (cons 360 "#6272a4")))
 '(vc-annotate-very-old-color nil)
 '(warning-suppress-types
   '((magit-todos) (magit-todos) (magit-todos) (magit-todos) (magit-todos)
     (magit-todos) (defvaralias))))
(custom-set-faces
